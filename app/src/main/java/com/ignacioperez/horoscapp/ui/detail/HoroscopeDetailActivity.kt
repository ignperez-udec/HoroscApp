...
import com.ignacioperez.horoscapp.databinding.ActivityHoroscopeDetailBinding
...
class HoroscopeDetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        initUI()
        horoscopeDetailViewModel.getHoroscope(args.type) //procesa el nombre del horoscope y carga la info
    }
