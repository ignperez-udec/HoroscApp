package com.ignacioperez.horoscapp.ui.luck
...
import com.ignacioperez.horoscapp.databinding.FragmentLuckBinding
import com.ignacioperez.horoscapp.ui.core.listeners.OnSwipeTouchListener
import com.ignacioperez.horoscapp.ui.providers.RandomCardProvider
...
class LuckFragment : Fragment() {
    ...
    private fun preparePrediction() {
        val currentLuck = randomCardProvider.getLuckey()
        //todo dentro del let no es nulo
    ...
    @SuppressLint("ClickableViewAccessibility") //suprime warning
    ...
    private fun spinRoulette() {
        ...
        animator.duration = 2000 //2 segundos
